...
# Criaremos a ToolBox, para fazer a inicializaçâo dos recursos da lib
toolbox = base.Toolbox()
# Vamos definir o FitnessMax, busca a de maior valor, pesos
# Aqui, teraemos valores entre 0 e 1, e, indicamos que o melhor será o mais próximo de 1
creator.create("FitnessMax", base.Fitness, weights=(1.0, ))
# O
creator.create("Individual", list, fitness=creator.FitnessMax)
# Vamos indicar os possiveis valores do cromossomo
